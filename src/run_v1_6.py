...
train_file_path = root_dir / 'data' / 'vctk' / 'speaker1' / f'{what_data}vctk-speaker1-train.4.16000.8192.4096.h5'      # Path to training data
test_file_path = root_dir / 'data' / 'vctk' / 'speaker1' / f'{what_data}vctk-speaker1-val.4.16000.8192.4096.h5.tmp'     # Path to test data
